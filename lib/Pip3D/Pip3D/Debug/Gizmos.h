...
#define DBG_LINE(renderer, a, b, color, categories)                  \
    do                                                               \
    {                                                                \
        ::pip3D::Debug::Gizmos::addLine(a, b, color, categories); \
    } while (0)

#define DBG_RAY(renderer, origin, dir, length, color, categories)                  \
    do                                                                             \
    {                                                                              \
        ::pip3D::Debug::Gizmos::addRay(origin, dir, length, color, categories); \
    } while (0)

#define DBG_AABB(renderer, box, color, categories)                  \
    do                                                              \
    {                                                               \
        ::pip3D::Debug::Gizmos::addAABB(box, color, categories); \
    } while (0)

#define DBG_SPHERE(renderer, center, radius, color, categories)                  \
    do                                                                           \
    {                                                                            \
        ::pip3D::Debug::Gizmos::addSphere(center, radius, color, categories); \
    } while (0)

#define DBG_AXES(renderer, origin, size, categories)                  \
    do                                                                \
    {                                                                 \
        ::pip3D::Debug::Gizmos::addAxes(origin, size, categories); \
    } while (0)
